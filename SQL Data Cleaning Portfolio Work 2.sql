...
-- Later i will delete SaleDate. I will use only SaleDateConverted as SaleDate.
...
-- Later i will delete OwnerAddress.
...
-- I will not delete the columns from my raw data. Just Write the Code.
